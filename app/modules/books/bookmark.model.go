...
type BookMark struct {
	ID           string         `json:"id"`
	UserID       uuid.UUID      `gorm:"type:uuid;not null, compositeIndex:idx_user_book" json:"user_id"`
	User         users.User     `json:"-"`
	BookID       uuid.UUID      `gorm:"type:uuid;not null,compositeIndex:idx_user_book" json:"book_id"`
	Book         Book           `json:"-"`
